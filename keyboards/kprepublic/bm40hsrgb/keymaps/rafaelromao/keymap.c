 ...
 */
    [2] = LAYOUT_planck_mit(
        KC_CAPS      , KC_LPRN      , KC_RPRN      , KC_DLR       , KC_PERC      , KC_NO      , RESET        , KC_BSLS      , KC_UNDS      , KC_QUES      , KC_SLSH      , KC_MINS,
 ...
 */
    [3] = LAYOUT_planck_mit(
        KC_F1, KC_F2, KC_F3, KC_F4, KC_PERC, KC_NO, KC, KC_P7, KC_P8, KC_P9, KC_PSLS, KC_MINS,
