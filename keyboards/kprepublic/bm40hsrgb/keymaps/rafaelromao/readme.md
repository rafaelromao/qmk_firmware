...
![img](https://i.imgur.com/VIMFfRj.png)
...
- Using the lower layer, we can use ", ', `, ~ and ^ as independent symbols, while in the left side of the raise layer, we can find these keycodes as accents. I had to program some macros in qmk to make it work this way though.
