...
- Tapping the outer left thumb key with the Gui/Ctrl mod stuck, clears all stuck mods.
- Tapping the outer right thumb key with a shift mod stuck, activates caps lock. One single tap deactivates caps lock when it is active.
