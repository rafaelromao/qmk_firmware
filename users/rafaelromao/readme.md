...
![img](https://i.imgur.com/Ppp0BcA.png)
...
- The mouse layer can be disabled (using the maintenance layer) or be unavailable (MOUSEKEY_ENABLED = false in rules.mk). In both cases, the navigation layer will be activated in its place instead.
